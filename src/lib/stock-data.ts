...
export const stocks: Stock[] = [
  ...
  },
  {
    ...
    risks: [
      "Oil price volatility could slow upstream capital spending plans",
      "Geopolitical exposure in Russia and Middle East creates headline risk",
      "Energy transition long-term headwinds on fossil fuel demand",
    ],
    catalysts: [
      "International rig count recovery still early innings outside North America",
      "Digital and AI-powered drilling optimization expanding margins",
      "Deepwater and subsea project sanctioning at highest level since 2013",
    ],
  },
  {
    ticker: "ELV",
    ...
    risks: [
      "Medicare Advantage rate pressure from CMS star rating changes",
      "Medical cost trend acceleration above pricing assumptions",
      "Political and regulatory risk around managed care profitability",
    ],
    catalysts: [
      "Carelon health services growing 20%+ as in-house PBM and care delivery scale",
      "Medicaid redetermination headwinds fading with membership stabilizing",
