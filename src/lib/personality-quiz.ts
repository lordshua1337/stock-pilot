...
export const archetypes: InvestorArchetype[] = [
  {
    ...
    idealAllocation: [
      ...
      { label: "Broad Market ETFs", pct: 30, color: "#00C853" },
  ...
  },
  {
    ...
    idealAllocation: [
      { label: "Dividend Growth Stocks", pct: 40, color: "#00C853" },
  ...
  },
  {
    ...
    idealAllocation: [
      { label: "Quality Growth Stocks", pct: 35, color: "#00C853" },
  ...
  },
  {
    ...
    idealAllocation: [
      { label: "High-Growth Stocks", pct: 45, color: "#00C853" },
  ...
  },
  {
    ...
    idealAllocation: [
      { label: "Concentrated Stock Picks (5-10)", pct: 50, color: "#00C853" },
  ...
  },
  {
    ...
    idealAllocation: [
      { label: "Total US Market ETF", pct: 50, color: "#00C853" },
