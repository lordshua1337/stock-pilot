      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          <p
            ...
            style={{ color: archetype ? (ARCHETYPE_COLORS[archetype] ?? "#2E8BEF") : "#2E8BEF" }}
          >
            Research
          </p>
        ...
        {archetype && dimensions && (() => {
          const accentColor = ARCHETYPE_COLORS[archetype] ?? "#2E8BEF";
          ...
          return (
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {top10.map((match, idx) => {
                  const fitColor = match.score >= 75 ? "#2E8BEF" : match.score >= 50 ? "#FFD740" : "#FF5252";
                  return (
                    <Link
        ...
        <div className="space-y-3">
          {filtered.map((stock) => {
            ...
            const accentColor = archetype ? (ARCHETYPE_COLORS[archetype] ?? "#2E8BEF") : undefined;
