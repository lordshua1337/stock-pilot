  ...
  if (authenticated === false) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        <Zap className="w-12 h-12 text-[#2E8BEF] mx-auto mb-4" />
        ...
        <Link href="/auth"
          className="inline-flex items-center gap-2 px-6 py-3 bg-[#2E8BEF] text-black font-semibold rounded-lg hover:bg-[#3B8FE0] transition-colors">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white flex items-center gap-3">
            <Zap className="w-8 h-8 text-[#2E8BEF]" />
            Flight Plan
          </h1>
        ...
        <button onClick={generatePlan} disabled={loading}
          className="flex items-center gap-2 px-4 py-2 bg-[#2E8BEF] text-black text-sm font-semibold rounded-lg hover:bg-[#3B8FE0] transition-colors disabled:opacity-50">
      ...
      {!plan && !loading && !error && (
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-12 text-center">
          ...
          <button onClick={generatePlan}
            className="px-6 py-2.5 bg-[#2E8BEF] text-black font-semibold rounded-lg hover:bg-[#3B8FE0] transition-colors text-sm">
