  ...
  if (authenticated === false) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/auth"
          className="inline-flex items-center gap-2 px-6 py-3 bg-[#006DD8] text-black font-semibold rounded-lg hover:bg-[#3B8FE0] transition-colors">
    ...
    <div className="max-w-2xl mx-auto px-4 py-12">
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={generatePlan} disabled={loading}
          className="flex items-center gap-2 px-4 py-2 bg-[#006DD8] text-black text-sm font-semibold rounded-lg hover:bg-[#3B8FE0] transition-colors disabled:opacity-50">
      ...
      {!plan && !loading && !error && (
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-12 text-center">
          ...
          <button onClick={generatePlan}
            className="px-6 py-2.5 bg-[#006DD8] text-black font-semibold rounded-lg hover:bg-[#3B8FE0] transition-colors text-sm">
