              ...
              <div className="flex items-center gap-3 pt-2 border-t border-[var(--border)]">
                ...
                <div className="flex gap-2 ml-auto">
                  <button
                    ...
                    style={{
                      borderColor: followedRule ? "#00C853" : "var(--border)",
                      background: followedRule ? "rgba(0,200,83,0.12)" : "transparent",
                      color: followedRule ? "#00C853" : "var(--text-muted)",
                    }}
                  >
                    Yes
                  </button>
...
function InsightCard({ insight }: { readonly insight: JournalInsight }) {
  const colorMap = {
    ...
    positive: { bg: "rgba(0,200,83,0.08)", border: "#00C853", icon: <CheckCircle2 className="w-4 h-4" /> },
